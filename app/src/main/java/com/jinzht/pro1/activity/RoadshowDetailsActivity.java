...
import com.jinzht.pro1.view.WrapContentHeightViewPager1;
...
public class RoadshowDetailsActivity extends BaseFragmentActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private WrapContentHeightViewPager1 detailsVpModule;// 详情页的ViewPager
    ...
    protected void init() {
        ...
        detailsVpModule = (WrapContentHeightViewPager1) findViewById(R.id.details_vp_module);// 详情页的ViewPager
