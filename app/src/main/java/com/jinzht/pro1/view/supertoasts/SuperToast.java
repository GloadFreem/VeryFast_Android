...
package com.jinzht.pro1.view.supertoasts;
...
import com.jinzht.pro1.view.supertoasts.util.Style;
...
public class SuperToast {
    ...
    public static class Icon {
        ...
        public static class Dark {
            ...
            public static final int EDIT = (R.mipmap.icon_dark_edit);
            public static final int EXIT = (R.mipmap.icon_dark_exit);
            public static final int INFO = (R.mipmap.icon_dark_info);
            public static final int REDO = (R.mipmap.icon_dark_redo);
            public static final int REFRESH = (R.mipmap.icon_dark_refresh);
            public static final int SAVE = (R.mipmap.icon_dark_save);
            public static final int SHARE = (R.mipmap.icon_dark_share);
            public static final int UNDO = (R.mipmap.icon_dark_undo);
        ...
        public static class Light {
            ...
            public static final int EDIT = (R.mipmap.icon_light_edit);
            public static final int EXIT = (R.mipmap.icon_light_exit);
            public static final int INFO = (R.mipmap.icon_light_info);
            public static final int REDO = (R.mipmap.icon_light_redo);
            public static final int REFRESH = (R.mipmap.icon_light_refresh);
            public static final int SAVE = (R.mipmap.icon_light_save);
            public static final int SHARE = (R.mipmap.icon_light_share);
            public static final int UNDO = (R.mipmap.icon_light_undo);
