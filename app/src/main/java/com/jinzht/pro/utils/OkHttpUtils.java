...
public class OkHttpUtils {
    ...
    // 登录
    public static String loginPost(String partner, String key1, String value1, String key2, String value2, String key3, String value3, String url, Context context) throws IOException {
        String body = "";
    ...
    // 微信登录
    public static String wechatLoginPost(String partner, String key1, String value1, String key2, String value2, String url, Context context) throws IOException {
        String body = "";
        RequestBody formBody = new FormEncodingBuilder()
                .add("key", "jinzht_server_security")
                .add("partner", partner)
    ...
    // 注册
    public static String registerPost(String partner, String key1, String value1, String key2, String value2, String key3, String value3, String key4, String value4, String key5, String value5, String url, Context context) throws IOException {
        String body = "";
        RequestBody formBody = new FormEncodingBuilder()
                .add("key", "jinzht_server_security")
                .add("partner", partner)
